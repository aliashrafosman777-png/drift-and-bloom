...
const packageBuilderProducts = [
  {
    ...
    catalogKey: 'candles:lavender candle',
  ...
  },
  {
    ...
    catalogKey: 'candles:vanilla candle',
    packageCategory: 'candles',
    category: ['candles'],
  ...
  },
  {
    ...
    productType: 'candles',
    candleCategory: 'art',
    catalogKey: 'candles:ocean breeze candle',
    packageCategory: 'candles',
    category: ['candles'],
